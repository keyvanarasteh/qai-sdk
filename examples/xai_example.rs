    ...
    let prompt = Prompt {
        messages: vec![Message {
            ...
            content: vec![Content::Text {
                text: "Explain the concept of zero-knowledge proofs in one sentence.".to_string(),
            }],
        }],
    };

    let options = GenerateOptions {
        model_id: "grok-beta".to_string(), // Adjust model ID as needed for xAI
        max_tokens: Some(100),
        temperature: None,
        top_p: None,
        stop_sequences: None,
